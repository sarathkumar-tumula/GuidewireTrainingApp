...
import com.guidewire.ab.domain.addressbook.impl.ABPolicyCompanyImpl;
...
import extensions.ab.internal.domain.addressbook.impl.ABPolicyCompanyExtInternal;
import extensions.ab.internal.domain.addressbook.impl.ABPolicyCompanyExtMethodsImpl;
...
public class ABPolicyCompanyExtStub
    extends ABPolicyCompanyImpl
    implements ABCompanyExtInternal, ABContactExtInternal, ABPolicyCompanyExtInternal, GlobalContactNameExtInternal
{


    @Override
    public Boolean isCollateralRequired() {
        return getExtensionDelegate(ABPolicyCompanyExtMethodsImpl.class).isCollateralRequired();
    }

    @Override
    public void setCollateralRequired(Boolean value) {
        getExtensionDelegate(ABPolicyCompanyExtMethodsImpl.class).setCollateralRequired(value);
    }

    @Override
    public Integer getCollateralAmount() {
        return getExtensionDelegate(ABPolicyCompanyExtMethodsImpl.class).getCollateralAmount();
    }

    @Override
    public void setCollateralAmount(Integer value) {
        getExtensionDelegate(ABPolicyCompanyExtMethodsImpl.class).setCollateralAmount(value);
    }

    @Override
    public YesNo getCompanyCollateralVerified() {
        return getExtensionDelegate(ABPolicyCompanyExtMethodsImpl.class).getCompanyCollateralVerified();
    }

    @Override
    public void setCompanyCollateralVerified(YesNo value) {
        getExtensionDelegate(ABPolicyCompanyExtMethodsImpl.class).setCompanyCollateralVerified(value);
    }
