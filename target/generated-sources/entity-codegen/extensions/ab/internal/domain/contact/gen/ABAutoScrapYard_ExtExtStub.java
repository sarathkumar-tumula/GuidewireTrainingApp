...
import extensions.ab.internal.domain.addressbook.impl.ABCompanyExtInternal;
import extensions.ab.internal.domain.addressbook.impl.ABCompanyExtMethodsImpl;
import extensions.ab.internal.domain.addressbook.impl.ABCompanyVendorExtInternal;
import extensions.ab.internal.domain.addressbook.impl.ABCompanyVendorExtMethodsImpl;
...
import extensions.ab.internal.domain.contact.impl.ABAutoScrapYard_ExtImpl;
...
public class ABAutoScrapYard_ExtExtStub
    extends ABAutoScrapYard_ExtImpl
    implements ABCompanyExtInternal, ABCompanyVendorExtInternal, ABContactExtInternal, GlobalContactNameExtInternal
{


    @Override
    public ABPerson getFinanceManager() {
        return getExtensionDelegate(ABCompanyVendorExtMethodsImpl.class).getFinanceManager();
    }

    @Override
    public void setFinanceManager(ABPerson value) {
        getExtensionDelegate(ABCompanyVendorExtMethodsImpl.class).setFinanceManager(value);
    }

    @Override
    public Key getFinanceManagerID() {
        return getExtensionDelegate(ABCompanyVendorExtMethodsImpl.class).getFinanceManagerID();
    }

    @Override
    public void setFinanceManagerID(Key value) {
        getExtensionDelegate(ABCompanyVendorExtMethodsImpl.class).setFinanceManagerID(value);
    }

    @Override
    public ABPerson getPaymentContact() {
        return getExtensionDelegate(ABCompanyVendorExtMethodsImpl.class).getPaymentContact();
    }

    @Override
    public void setPaymentContact(ABPerson value) {
        getExtensionDelegate(ABCompanyVendorExtMethodsImpl.class).setPaymentContact(value);
    }

    @Override
    public Key getPaymentContactID() {
        return getExtensionDelegate(ABCompanyVendorExtMethodsImpl.class).getPaymentContactID();
    }

    @Override
    public void setPaymentContactID(Key value) {
        getExtensionDelegate(ABCompanyVendorExtMethodsImpl.class).setPaymentContactID(value);
    }

    @Override
    public ManagerRelationshipType getFinanceMgrRelationship() {
        return getExtensionDelegate(ABCompanyVendorExtMethodsImpl.class).getFinanceMgrRelationship();
    }

    @Override
    public void setFinanceMgrRelationship(ManagerRelationshipType value) {
        getExtensionDelegate(ABCompanyVendorExtMethodsImpl.class).setFinanceMgrRelationship(value);
    }

    @Override
    public Boolean isCanAddEmployees() {
        return getExtensionDelegate(ABCompanyExtMethodsImpl.class).isCanAddEmployees();
    }

    @Override
    public void setCanAddEmployees(Boolean value) {
        getExtensionDelegate(ABCompanyExtMethodsImpl.class).setCanAddEmployees(value);
    }

    @Override
    public Boolean isInspectionRequired() {
        return getExtensionDelegate(ABCompanyExtMethodsImpl.class).isInspectionRequired();
    }

    @Override
    public void setInspectionRequired(Boolean value) {
        getExtensionDelegate(ABCompanyExtMethodsImpl.class).setInspectionRequired(value);
    }

    @Override
    public Date getInspectionDate() {
        return getExtensionDelegate(ABCompanyExtMethodsImpl.class).getInspectionDate();
    }

    @Override
    public void setInspectionDate(Date value) {
        getExtensionDelegate(ABCompanyExtMethodsImpl.class).setInspectionDate(value);
    }

    @Override
    public Integer getEmployeeScore() {
        return getExtensionDelegate(ABCompanyExtMethodsImpl.class).getEmployeeScore();
    }

    @Override
    public void setEmployeeScore(Integer value) {
        getExtensionDelegate(ABCompanyExtMethodsImpl.class).setEmployeeScore(value);
    }
    ...
    @Override
    public ContactTier getContactTier() {
        return getExtensionDelegate(ABContactExtMethodsImpl.class).getContactTier();
    }

    @Override
    public void setContactTier(ContactTier value) {
        getExtensionDelegate(ABContactExtMethodsImpl.class).setContactTier(value);
    }
