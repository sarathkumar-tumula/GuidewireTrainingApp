...
class BundleExamples {
  ...
  */
  public static function setInspectionDateByLoadBean(key: Key, inspectionDate: DateTime): String {
 ...
 */
  public static function setInspectionDateWithBundle(anABContact: ABCompany, inspectionDate: DateTime): String {
    var returnString: String
  ...
  /**
      Helper Method
  */
  private static function createABCompanyNoteForInspection(targetCompany: ABCompany, inspectionDate: DateTime): ContactNote {
    ...
    var originalInspectionDate = targetCompany.getOriginalValue(ABCompany#InspectionDate)
