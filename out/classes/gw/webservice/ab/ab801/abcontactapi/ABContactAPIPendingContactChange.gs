...
@gw.xml.ws.annotation.WsiExportable( "http://guidewire.com/ab/ws/gw/webservice/ab/ab801/abcontactapi/ABContactAPIPendingContactChange" )
@Export
final class ABContactAPIPendingContactChange {
  ...
  public function populatePendingContactChange(contactChange : PendingContactChange, updateXML : XmlBackedInstance, contactForChange : ABContact) {
