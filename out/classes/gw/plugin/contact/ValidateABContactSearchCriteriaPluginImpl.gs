...
class ValidateABContactSearchCriteriaPluginImpl implements ValidateABContactSearchCriteriaPlugin {
  ...
  private final var _localeCodeCountry : Map<String, typekey.Country> = {
      LocaleType.TC_DE_DE.Code -> Country.TC_DE,
      LocaleType.TC_EN_AU.Code -> Country.TC_AU,
      LocaleType.TC_EN_CA.Code -> Country.TC_CA,
      LocaleType.TC_EN_GB.Code -> Country.TC_GB,
      LocaleType.TC_EN_US.Code -> Country.TC_US,
      LocaleType.TC_FR_CA.Code -> Country.TC_CA,
      LocaleType.TC_FR_FR.Code -> Country.TC_FR,
      LocaleType.TC_JA_JP.Code -> Country.TC_JP
  }
