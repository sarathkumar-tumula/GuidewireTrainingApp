 ...
 */
@Export
class ValidateABContactCreationPluginImpl implements ValidateABContactCreationPlugin, InitializablePlugin {

  private var _requiresTaxID : boolean as RequiresTaxID
