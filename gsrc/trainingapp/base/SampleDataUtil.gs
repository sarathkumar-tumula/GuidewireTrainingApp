...
class SampleDataUtil {
  ...
  static function loadTrainingAppSampleData () : void {
    try {
      ...
      LocationUtil.addRequestScopedInfoMessage(displaykey.Training.TrainingAppSampleDataLoaded)
    } catch (e : java.lang.Exception) {
        throw new DisplayableException (displaykey.Training.TrainingAppSampleDataNOTLoaded)
    }
  }
